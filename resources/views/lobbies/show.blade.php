        ...
        <div class="flex justify-between items-center">
            ...
            @if($isOwner)
                <div class="flex gap-2">
                    {{-- 1. Tambahkan array [$competition, $lobby] di sini --}}
                    ...
                    {{-- 2. Tambahkan array [$competition, $lobby] di sini --}}
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                @if(!$isOwner)
                    <div class="mt-5 pt-5 border-t border-gray-100">
                        @if($isMember)
                            <form action="{{ route('competitions.lobbies.leave', [$competition, $lobby]) }}" method="POST">
                                @csrf
                                @method('DELETE')
                        ...
                        @else
                            <form action="{{ route('competitions.lobbies.join', [$competition, $lobby]) }}" method="POST">
                                @csrf
            ...
            <div class="bg-white rounded-xl shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    @if($isOwner)
                        {{-- Gunakan $lobby saja karena route ini mungkin tidak nested kompetisi --}}
